...
#set directory
setwd("C:/Users/yangy/Documents/Datos Seba/Linear Mixed Models")
...
alldata = data.frame(as.factor(datos_long_v2_trab$ID_check),
                     ...
                     as.numeric(as.character(datos_long_v2_trab$reward)),
...
lm.dec_full <- glmer(choise ~ c.reward*c.effort*condition + (1+c.effort+c.reward|ID_check),
                     data=alldata.sc, 
                     family=binomial,
                     control = glmerControl(optimizer = "bobyqa",
                                            optCtrl=list(maxfun=2e5)))

lmInt.dec_full <-glmer(choise ~ c.reward*condition*c.effort*c.trial + (1+c.effort+c.reward|ID_check),
                       data=alldata.sc, 
                       family=binomial,
                       control = glmerControl(optimizer = "bobyqa",
                                              optCtrl=list(maxfun=2e5)))
